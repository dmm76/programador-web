...
-- Copiando dados para a tabela ferramentas.emprestimo: ~1 rows (aproximadamente)
INSERT INTO `emprestimo` (`id`, `cadastro`, `id_ferramenta`, `id_usuario`, `data_emprestimo`, `data_devolucao`) VALUES
	(18, '2025-09-08 17:34:35', 1, 4, '2025-09-08', '2025-09-08');
...
INSERT INTO `ferramenta` (`id`, `cadastro`, `nome`, `descricao`, `status`, `estado`) VALUES
	...
	(4, '2025-09-02 18:29:16', 'Alicate', 'alicate grande panis', 'disponível', 'semi novo'),
	(5, '2025-09-02 19:35:52', 'Cortador de Grama', 'aparador', 'disponível', 'novo'),
	(6, '2025-09-03 17:46:26', 'Marreta', 'marreta de demolição', 'disponível', 'usada'),
	(7, '2025-09-03 19:54:31', 'Chave de fenda pequena', 'chave de fenda pequena', 'disponível', 'Otimo'),
...
-- Copiando dados para a tabela ferramentas.reserva: ~4 rows (aproximadamente)
INSERT INTO `reserva` (`id`, `id_ferramenta`, `id_usuario`, `data_reserva`, `status`) VALUES
	(16, 1, 4, '2025-09-08 14:34:11', 'atendida');
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `nivel` varchar(50) NOT NULL DEFAULT 'comum',
  PRIMARY KEY (`id`),
  UNIQUE KEY `email` (`email`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela ferramentas.usuario: ~4 rows (aproximadamente)
INSERT INTO `usuario` (`id`, `cadastro`, `nome`, `email`, `senha`, `apartamento`, `nivel`) VALUES
	(1, '2025-09-02 17:13:28', 'Douglas Marcelo Monquero', 'douglas@email.com', 'e10adc3949ba59abbe56e057f20f883e', 'bl03 apt212', 'admin'),
	(3, '2025-09-02 18:29:46', 'Patricia Alves', 'paty@email.com.br', 'd41d8cd98f00b204e9800998e', 'bl03 apt21', 'comum'),
	(4, '2025-09-02 19:34:38', 'João Ferlini', 'joao@email.com.br', '81dc9bdb52d04dc20036dbd8313ed055', 'bl01 apt24', 'comum'),
	(7, '2025-09-03 18:59:12', 'Carlos Massa', 'carlos.massa@email.com', '81dc9bdb52d04dc20036dbd8313ed055', 'bl01 apt55', 'comum');
